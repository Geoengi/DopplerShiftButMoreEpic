...
/datum/mood_event/epilepsy_soon //timeout is equal to the delay before the seizure proc triggers
	description = "I feel like my world could crash down any moment now..."
	mood_change = -6
	timeout = 30 SECONDS

/datum/mood_event/epilepsy
	description = "It feels like someone cleaved my brain in two!"
	mood_change = -8
	timeout = 3 MINUTES
